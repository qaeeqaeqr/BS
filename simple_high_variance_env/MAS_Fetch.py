...
class GameEnv:
    ...
    def render_env(self):
        ...
        a = np.stack([np.resize(np.ascontiguousarray(a[:, :, 0]), (10 * self.size_y, 10 * self.size_x)),
                      np.resize(np.ascontiguousarray(a[:, :, 1]), (10 * self.size_y, 10 * self.size_x)),
                      np.resize(np.ascontiguousarray(a[:, :, 2]), (10 * self.size_y, 10 * self.size_x))], axis=2)
        return a
